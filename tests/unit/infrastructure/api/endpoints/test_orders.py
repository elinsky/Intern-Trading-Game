...
class TestOrderEndpoints:
    ...
    def test_submit_valid_limit_order_queue_message(self, client, team_info, mock_auth):
    ...
    def test_submit_valid_limit_order_with_response(self, client, team_info, mock_auth):
    ...
    def test_order_timeout_handling(self, client, team_info, mock_auth):
        ...
        with patch("intern_trading_game.api.endpoints.orders.get_order_queue") as mock_queue, \
             patch("intern_trading_game.api.endpoints.orders.get_pending_orders") as mock_pending, \
             patch("intern_trading_game.api.endpoints.orders.get_order_responses") as mock_responses:
