...
from intern_trading_game.domain.interfaces import TradingStrategy
from intern_trading_game.domain.models import GameConfig
from intern_trading_game.game.game_loop import GameLoop
...
class MockStrategy(TradingStrategy):
    ...
    def make_trading_decision(self, market_data, context):
        ...
        from intern_trading_game.domain.interfaces import StrategyAction
